...
// ── POST /api/verify — Vérifie si un fichier est du contenu IA
...
router.get('/:contentId', optionalAuth, (req, res) => {
  ...
  const badge = { silver: '🥈 Certifié Argent', bronze: '🥉 Certifié Bronze', unknown: '⚠��#� Non certifié', failed: '❌ Rejeté' }[row.certification_level] ?? '⚠️ Inconnu';
