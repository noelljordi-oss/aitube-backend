...
const upload = multer({ storage, fileFilter, limits: { fileSize: parseInt(process.env.MAX_FILE_SIZE) || 524288000 } });

function getContentTypeFromMime(mime) { return ALLOWED_TYPES[mime]?.contentType || null; }
